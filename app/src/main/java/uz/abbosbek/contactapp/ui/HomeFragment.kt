...
import uz.abbosbek.contactapp.databinding.FragmentHomeBinding
...
//             }
    ...
    private fun askContactPermission() {
        askPermission(
            ...
            Thread {
                ...
                contactList = readContactFromPhone() as ArrayList<ContactInfo>
    ...
    private fun readContactFromPhone(): List<ContactInfo> {
    ...
    override fun rvItemClicked(user: ContactInfo, position: Int) {
        findNavController().navigate(
            R.id.viewUserFragment, bundleOf("user" to user, "position" to position)
        )
    }

    override fun rvCallClicked(user: ContactInfo) {
        askCallPermission(user)

    }

    override fun rvSmsClicked(user: ContactInfo) {
        findNavController().navigate(R.id.sentSmsFragment, bundleOf("user" to user))
    }

    private fun askCallPermission(user: ContactInfo) {
        askPermission(
